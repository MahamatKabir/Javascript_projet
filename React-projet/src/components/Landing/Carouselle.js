...
const Carouselle = (n) => {
  ...
  return (
    <div className="item">
      ...
      <div className="modification1">
        <div className="modification">
          <Card className="cardlar" style={{ width: '18rem' }}>
            <Card.Img variant="top" src="image1.jpg" />
            <Card.Body>
              ...
              <Link to="/galeri" variant="primary">Go somewhere</Link>
            </Card.Body>
          </Card>
          <Card className="cardlar" style={{ width: '18rem' }}>
            <Card.Img variant="top" src="image1.jpg" />
          ...
          <Card className="cardlar" style={{ width: '18rem' }}>
            <Card.Img className="imag" variant="top" src="image1.jpg" />
            <Card.Body>
              <Card.Title>Card Title</Card.Title>
              <Card.Text>
                Some quick example text to build on the card title and make up the bulk of
      ...
      <div className="cercl-container"></div>
      <div className="forte-container">
                ...
                <div className="our_solution_category">
                  <div className="solution_cards_box">
                    <div className="solution_card">
                      ...
                      <div className="solu_description">
                        <Card.Img className="anim-photo" variant="top" src="image1.jpg" />
                        <p>
                  ...
                  <div className="solution_cards_box sol_card_top_3">
                    <div className="solution_card">
                      ...
                      <div className="solu_description">
                        <Card.Img variant="top" src="images4.jpg" />
                        <p>
                          It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
                        </p>
                        <button type="button" className="read_more_btn">Read More</button>
        ...
        <div className="deco2">
          ...
          <div className="decoration9"></div>
        </div>

      </div>
      <div className="cercle-container"></div>
      <div className="tchad-container">
        <Card className="tchad text-center">
      ...
      <div className="contact-form">
        <div class="row">
          <div class="col-md-6 offset-md-3">
            <br /><br />
            <h3 className="register">Register Form</h3><br />
            <form>
              <div class="form-row">
